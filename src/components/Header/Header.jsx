...
const Header = () => {
  return (
    <header className="header">
      <aside className="site-message bg-(--color-black)">
        <div className="site-message-container p-[10px_38px] flex flex-row items-center justify-center relative">
          <div className="viewport text-(--color-white) relative w-[375px] overflow-hidden cursor-grab">
            <div className="animate-slide flex justify-center min-w-full">
              <div className="content-item min-w-full text-[14px] font-normal font-[Lato,sans-serif] leading-[24px] tracking-[1px] text-center">
                <a href="" className="underline bg-transparent">
                  Join the waitlist
                </a>
          ...
          <button className="site-message__close absolute bg-transparent right-[13px] top-[50%] translate-y-[-50%]">
      ...
      <div className="header-container h-[65px] min-h-[101px] md:min-h-[141px] m-[0_0_-101px] md:m-[0_0_-142px]">
        <div className="header-wrapper relative top-0 left-0 right-0 z-10">
          <div className="header-grid p-[20px_0] grid grid-cols-[1fr_minmax(343px,22fr)_1fr] lg:grid-cols-[1fr_28fr_1fr]">
            <div className="header-content col-[2/3] flex justify-between items-center min-h-[25px]">
              <nav className="header__nav hidden lg:block">
                <ul className="nav__list flex flex-row gap-10 text-(--color-white) list-none">
                  {["watches", "design", "craft", "about", "stories"].map((item) => (
                    <li key={item} className="nav-item">
                      <a href="" className="nav-item__link after:bottom-[-4px] after:h-[0.5px]">
                        <span className="link-text leading-[1px]">{item}</span>
                      </a>
                    </li>
                  ))}
                </ul>
              ...
              <div className="header__logo text-(--color-white) absolute left-[50%] translate-x-[-50%] top-[13px]">
                <a href="#">
                  <svg className="h-[50px] lg:h-[75px]" viewBox="0 0 262.57 148.81">
                    <title>VIEREN Logo</title>
                    <g fill="currentColor">
              ...
              <nav className="header__nav order-2">
                <ul className="nav__list flex flex-row gap-8 lg:gap-10 text-(--color-white) list-none items-center">
                  <li className="nav-item">
                    <button className="nav-item__btn flex items-center after:bottom-[-10px] after:h-[1px]">
                      <span className="btn-text leading-[1.15px]">
                        $usd
                      </span>
                    </button>
                  </li>
              ...
              <button className="nav__burger lg:hidden order-1">
                <svg
