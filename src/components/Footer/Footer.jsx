  ...
  return (
    <footer className="site-footer bg-[#242424]">
      <div className="site-footer__container grid grid-cols-[1fr_minmax(343px,22fr)_1fr] lg:grid-cols-[1fr_28fr_1fr]">
        <div className="site-footer__wrapper col-[2/3] pt-10 pb-15 flex flex-row justify-between">
          <div className="site-footer__content w-full flex justify-between">
            <div className="site-footer__left flex flex-row gap-20">
              <div className="site-footer__subscription email">
                <div className="email__content flex flex-col gap-[27px]">
                  <div className="email__text flex flex-col justify-center items-start text-(--color-white)">
                    <h3 className="email__title text-[22px] font-normal font-[Lato,sans-serif] leading-[27px] tracking-[1px] mb-[2px] uppercase">
                      JOIN THE MOVEMENT
                    </h3>
                    <p className="email__description text-[14px] font-light font-[Lato,sans-serif] leading-[26px] tracking-[0.88px]">
                    ...
                    <div className="email__form-inner relative">
                      <input 
                        ...
                        className="email__input bg-(--color-white) h-[31px] z-1 border-1 border-[#bbbbbb] w-full px-[0.5em] text-[15px] font-light font-[Lato,sans-serif] 
                          leading-[30px] tracking-[0.5px] placeholder:text-[#bbbbbb] focus:outline-2 focus:outline-(--color-black) focus:outline-offset-[-3.5px] 
                          focus:rounded-[4px]"
                      />
                      <button 
                        type="submit" 
                ...
                <ul className="site-footer__nav-list flex gap-[30px]">
                  {[
                    ...
                    <li className="site-footer__nav-column" key={section.title}>
                      <h5 className="site-footer__nav-title">{section.title}</h5>
            ...
            <div className="flex flex-col gap-15">
              <div className="flex flex-col gap-4 justify-center items-center min-w-[75px]">
                <span className="text-(--color-white) font-[Lato,sans-serif] text-[14px] font-normal tracking-[0.78px] leading-[30px] uppercase">
                  @VIERENTIME
                </span>

                <div className="socialBar flex flex-row gap-7 items-center justify-center">
                  <a href="" className="instagram">
                    <svg className="text-(--color-white) block h-5 w-auto" viewBox="0 0 448 512">
                  ...
                  <a href="" className="facebook">
                    <svg className="text-(--color-white) block h-[21px] w-auto" viewBox="0 0 320 512">
                      <path fill="currentColor" d="M279.14 288l14.22-92.66h-88.91v-60.13c0-25.35 12.42-50.06 52.24-50.06h40.42V6.26S260.43 0 225.36 0c-73.22 0-121.08 44.38-121.08 124.72v70.62H22.89V288h81.39v224h100.17V288z" />
                    </svg>
                  </a>
                  <a href="" className="youtube">
                    <svg className="text-(--color-white) block h-[15px] w-auto" viewBox="0 0 576 512">
              ...
              <div className="min-w-[190px] flex flex-col items-center gap-[11px]">
                <span className="flex flex-row items-center justify-center text-[#a2a2a2] text-[9.6px] font-normal font-[Lato,sans-serif] leading-[20.8px] tracking-[0.54px] uppercase">
                  <svg className="h-[14px] mr-[1ch]" width="15.8695652px" height="19px" viewBox="0 0 15.8695652 19">
                    <title>lock</title>
                ...
                <div className="cardblock flex flex-row justify-center gap-2.5 items-center">
                  <div className="max-w-[23px] overflow-hidden">
                  </div>
                  <div className="">
        ...
        <div className="site-footer__bottom-container p-[20px_0] flex flex-col lg:flex-row gap-2.5 lg:gap-0 justify-between items-center align-middle col-[2/3]">
          ...
          <div className="site-footer__links flex gap-5 align-middle items-center mr-5 lg:mr-0">
            {["Terms & Conditions", "Privacy Policy"].map((link) => (
              <a href="#" className="site-footer__link" key={link}>
